...
import static com.LokoTechnology.maingoquizagain.QuizActivity.dbkey;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btStartQuiz = findViewById(R.id.result_bt_playAgain);  //yeniden başla
        ...
        btMainMenu.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(ResultActivity.this,Kategori.class);
